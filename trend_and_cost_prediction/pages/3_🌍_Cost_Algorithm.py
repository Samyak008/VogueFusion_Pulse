...
def calculate_cost(fabric_gsm, total_color_weight=7):
    ...
    for i, target_rgb in enumerate(colors):
        ...
        st.write(i, color_weight)  # Debugging: Display color weight
        ...
        for dye, proportion in zip(dyes, best_proportions):
            if proportion > 0.01:  # Filter negligible proportions
                ...
                st.write(f"Dye: {dye['color']}, Proportion: {proportion:.2%}, Dye Weight: {dye_weight}, Dye Cost: ₹{dye_cost}")  # Debugging: Display dye info
